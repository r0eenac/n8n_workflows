...
If n8n is running in a Docker container, do not use localhost for the URL.

Use the Internal IP of the host machine (e.g., 192.168.1.100) or the container name if they share a Docker network.
...
Files upload to wrong location: Check the filename format. The Regex expects a year in the filename (e.g., Salary_2024.pdf). Valid pattern: 202[0-9].
